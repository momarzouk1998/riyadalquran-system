    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-950 via-emerald-900 to-slate-950 flex flex-col justify-center items-center p-4 relative overflow-hidden font-cairo">
      ...
      <div className="w-full max-w-lg relative z-10 space-y-6">
        ...
        <div className="text-center space-y-3">
          ...
          <div>
            <h1 className="text-2xl sm:text-3xl font-black text-white">بوابة أولياء الأمور</h1>
            <p className="text-xs text-emerald-200 mt-1">الدخول برقم المحمول لمتابعة درجات وتقارير طفلك</p>
          </div>
        </div>
        ...
        {multipleStudents ? (
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-slate-300 mt-0.5">
                      كود: {child.sequence} • المعلمة: {child.teacherName}
                    </p>
                  </div>
          ...
          <div className="glass-dark p-8 rounded-3xl border border-emerald-500/30 shadow-2xl space-y-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <label className="block text-xs font-bold text-emerald-100 mb-2">رقم المحمول أو كود الطالب</label>
