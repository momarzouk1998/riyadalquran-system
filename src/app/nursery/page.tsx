      ...
      <section className="max-w-6xl w-full mx-auto px-4 py-8 space-y-8">
        ...
        <div className="bg-gradient-to-r from-emerald-900 to-slate-900 rounded-3xl p-6 text-white space-y-3 border border-white/10 shadow-xl">
          <div className="flex items-center gap-2 text-amber-300 font-black text-sm">
            ...
            <span>كادر المعلمات والرقابة الإشرافية المتخصصة</span>
          </div>
          <p className="text-xs text-emerald-100 leading-relaxed">
            جميع معلمات الحضانة متأهلات لقيادة فصول الختمة، وحاصلات على دورات معتمدة في نور البيان من عرب الرمل، ودورات في اللغة الإنجليزية والكمبيوتر.
            تتم متابعة وتقييم الفصول والمعلمات دورياً من كبار المشايخ والمشرفين (الشيخ فتحي محمد عبد الحميد، الشيخ عمر من كفر شكر، الشيخ إسماعيل والشيخ محمد الحلواني من عرب الرمل).
          </p>
        </div>
