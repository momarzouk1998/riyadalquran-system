...
import { HandCoins, ArrowRight, CheckCircle, Loader2 } from 'lucide-react';
import { submitRegistrationRequest } from '@/app/actions/admin';

export default function RegisterPoorPage() {
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-yellow-50 flex flex-col" dir="rtl">
      ...
      <div className="flex-1 flex items-start justify-center px-4 py-10">
        <div className="w-full max-w-xl bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden">
          {/* Title */}
          <div className="bg-gradient-to-l from-primary to-green-700 px-8 py-6 text-white">
          ...
          <div className="p-8">
            {done ? (
              <div className="text-center py-8 space-y-4">
                ...
                <h3 className="text-xl font-black text-gray-800">تم إرسال طلبك بنجاح</h3>
                <p className="text-sm text-gray-500 leading-relaxed">
                  سيتم مراجعة طلبك من قِبل إدارة الجمعية والتواصل معك في أقرب وقت.
                </p>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <input name="familySize" type="number" min={1} max={30} placeholder="مثال: 5" className="form-input-modern" />
                  </div>
                  ...
                  <div className="space-y-1.5">
                    <label className="text-sm font-bold text-gray-700">الدخل الشهري التقريبي (ج.م)</label>
