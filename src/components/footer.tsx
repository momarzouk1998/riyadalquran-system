        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="text-center lg:text-right space-y-4">
            ...
            <div className="flex justify-center lg:justify-start gap-3 pt-2">
              <a href="https://wa.me/201010453630" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-xl bg-[#25D366] text-white flex items-center justify-center hover:scale-110 transition-all shadow-md">
          ...
          <div>
            ...
            <ul className="space-y-3 text-muted text-xs font-semibold">
              ...
              <li><Link href="/nursery" className="hover:text-primary transition-colors">• منظومة الحضانة المتقدمة</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-muted text-xs font-semibold">
              ...
              <li><Link href="/nursery" className="hover:text-primary transition-colors">• حجز مقعد لطفلك بالحضانة</Link></li>
              <li><a href="https://wa.me/201010453630" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">• التواصل والاستفسارات</a></li>
            </ul>
          </div>
          ...
          <div>
            <div className="flex items-center gap-2 mb-6">
              ...
              <h3 className="text-xl font-bold text-slate-900"><span className="text-primary">طرق التبرع</span> والاتصال</h3>
            </div>
            <div className="space-y-4 text-muted text-xs font-semibold">
              ...
              <div className="flex items-center gap-3">
                ...
                <p>البنك الزراعي المصري: حساب 1300</p>
              </div>
              
              {/* Vodafone Cash & InstaPay Badges */}
              <div className="pt-2 flex flex-wrap gap-2">
                <div className="inline-flex items-center gap-2 px-3 py-2 rounded-xl bg-red-50 border border-red-200 text-red-700 font-bold text-[11px] shadow-sm">
                  <Smartphone className="w-4 h-4 text-red-600" />
                  <span>فودافون كاش:</span>
                  <span className="font-mono text-red-900" dir="ltr">01010453630</span>
                </div>
                <div className="inline-flex items-center gap-2 px-3 py-2 rounded-xl bg-purple-50 border border-purple-200 text-purple-700 font-bold text-[11px] shadow-sm">
                  <Zap className="w-4 h-4 text-purple-600" />
                  <span>انستاباي:</span>
                  <span className="font-mono text-purple-900" dir="ltr">01281660541</span>
                </div>
              </div>
            </div>
          </div>
