...
export async function ensureDatabaseTables() {
  ...
  const tables = [
    ...
    `CREATE TABLE IF NOT EXISTS "Student" (
      ...
      "registrationType" TEXT NOT NULL DEFAULT 'new',
      "yearsInNursery" INTEGER NOT NULL DEFAULT 1,
      "isFinalYear" BOOLEAN NOT NULL DEFAULT 0,
      "notes" TEXT,
      "isActive" BOOLEAN NOT NULL DEFAULT 1,
      "teacherId" TEXT,
      "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  ...
  const migrations = [
    ...
    `ALTER TABLE "Student" ADD COLUMN "startDate" DATETIME;`,
    `ALTER TABLE "Student" ADD COLUMN "paymentStatus" TEXT NOT NULL DEFAULT 'unpaid';`,
    `ALTER TABLE "Student" ADD COLUMN "registrationType" TEXT NOT NULL DEFAULT 'new';`,
    `ALTER TABLE "Student" ADD COLUMN "yearsInNursery" INTEGER NOT NULL DEFAULT 1;`,
    `ALTER TABLE "Student" ADD COLUMN "isFinalYear" BOOLEAN NOT NULL DEFAULT 0;`,
    `ALTER TABLE "RegistrationRequest" ADD COLUMN "startDate" DATETIME;`,
    `ALTER TABLE "RegistrationRequest" ADD COLUMN "paymentStatus" TEXT NOT NULL DEFAULT 'unpaid';`,
    `ALTER TABLE "RegistrationRequest" ADD COLUMN "registrationType" TEXT NOT NULL DEFAULT 'new';`,
    `ALTER TABLE "RegistrationRequest" ADD COLUMN "yearsInNursery" INTEGER NOT NULL DEFAULT 1;`,
    `ALTER TABLE "RegistrationRequest" ADD COLUMN "isFinalYear" BOOLEAN NOT NULL DEFAULT 0;`,
